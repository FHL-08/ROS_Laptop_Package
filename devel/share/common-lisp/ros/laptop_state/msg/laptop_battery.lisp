...
(cl:in-package laptop_state-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <laptop_battery>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'laptop_battery)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laptop_state-msg:<laptop_battery> is deprecated: use laptop_state-msg:laptop_battery instead.")))

(cl:ensure-generic-function 'battery_level-val :lambda-list '(m))
(cl:defmethod battery_level-val ((m <laptop_battery>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laptop_state-msg:battery_level-val is deprecated.  Use laptop_state-msg:battery_level instead.")
  (battery_level m))
