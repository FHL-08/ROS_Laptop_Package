// Generated by gencpp from file battery_state/syst_msgs.msg
// DO NOT EDIT!


#ifndef BATTERY_STATE_MESSAGE_SYST_MSGS_H
#define BATTERY_STATE_MESSAGE_SYST_MSGS_H
...
struct syst_msgs_
{
  ...
  typedef boost::shared_ptr< ::battery_state::syst_msgs_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::battery_state::syst_msgs_<ContainerAllocator> const> ConstPtr;

}; // struct syst_msgs_

typedef ::battery_state::syst_msgs_<std::allocator<void> > syst_msgs;

typedef boost::shared_ptr< ::battery_state::syst_msgs > syst_msgsPtr;
typedef boost::shared_ptr< ::battery_state::syst_msgs const> syst_msgsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::battery_state::syst_msgs_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::battery_state::syst_msgs_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::battery_state::syst_msgs_<ContainerAllocator1> & lhs, const ::battery_state::syst_msgs_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::battery_state::syst_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::battery_state::syst_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::battery_state::syst_msgs_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::battery_state::syst_msgs_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::battery_state::syst_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::battery_state::syst_msgs_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::battery_state::syst_msgs_<ContainerAllocator> >
{
  ...
  static const char* value(const ::battery_state::syst_msgs_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1fb59ff803a9d3deULL;
  static const uint64_t static_value2 = 0x0eb752fb88926c23ULL;
};

template<class ContainerAllocator>
struct DataType< ::battery_state::syst_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::battery_state::syst_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::battery_state::syst_msgs_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::battery_state::syst_msgs_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::battery_state::syst_msgs_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // BATTERY_STATE_MESSAGE_SYST_MSGS_H
